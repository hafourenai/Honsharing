...
import { Menu, Clock, MoreHorizontal } from "lucide-react"
    ...
    >
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <button 
          ...
          className="md:hidden flex h-8 w-8 items-center justify-center rounded-full text-honey-text-primary transition-colors hover:bg-[#1e1830]"
        >
      ...
      <div className="flex items-center gap-1">
        <button className="flex h-8 w-8 items-center justify-center rounded-full text-[#9b8ec4] transition-colors hover:bg-[#1e1830]">
