/**
 * ============================================================
 * SKENARIO TESTING: BURNOUT
 * ============================================================
 *
 * Skenario ini menguji kemampuan chatbot dalam menangani
 * curhat tentang burnout — kelelahan fisik dan mental
 * akibat tekanan berkepanjangan.
 *
 * Karakteristik burnout:
 * - Kelelahan ekstrem (fisik dan mental)
 * - Sinisme terhadap pekerjaan/kuliah
 * - Penurunan performa dan motivasi
 * - Merasa tidak berdaya dan putus asa
 *
 * PENTING:
 *   Chatbot harus bisa membedakan antara "kelelahan biasa"
 *   dan burnout yang membutuhkan intervensi profesional.
 *
 * @author  Tim Skripsi
 * @version 1.0
 * ============================================================
...
/**
 * Skenario 1: Burnout kerja/kuliah
 * User merasa kelelahan total dengan rutinitas.
 */
  ...
  expectedRetrievedContext: [
    {
      ...
      emotions: ["burnout", "exhausted", "hopeless"],
      needs: ["rest", "validation", "purpose"],
    },
  ],
 ...
 * User terlalu banyak kegiatan organisasi sampai kelelahan.
 */
 ...
 * User memaksakan diri bekerja terus tanpa istirahat.
 */
  ...
  expectedRetrievedContext: [
    {
      ...
      expectedRelevanceScore: 0.85,
      emotions: ["burnout", "exhausted", "anxious", "frustrated"],
      needs: ["rest", "validation", "self-care", "balance"],
    },
  ],
