...
export const multiOverthinkingMalam: MultiTurnScenario = {
  ...
  name: "Overthinking Malam Hari — Perkembangan Menuju Tenang",
  description:
...
export const multiKecemasanSosial: MultiTurnScenario = {
  ...
  name: "Kecemasan Sosial — Persiapan Presentasi",
  description:
...
export const multiMasalahHubungan: MultiTurnScenario = {
  ...
  name: "Masalah Hubungan — Konflik dengan Pasangan",
  description:
    "User mengalami konflik berantai dengan pasangan. Dari marah → sedih → menerima.",
...
export const multiKeluargaTekanan: MultiTurnScenario = {
  ...
  name: "Keluarga — Tekanan Orang Tua Soal Masa Depan",
  description:
    "User merasa tertekan dengan ekspektasi orang tua. Dari frustrasi → sedih → mencari solusi.",
  category: "keluarga",
  initialSeverity: 4,
  turns: [
    {
...
export const multiKehilanganMotivasi: MultiTurnScenario = {
  ...
  name: "Kehilangan Motivasi — Proses Bangkit Kembali",
  description:
    "User kehilangan motivasi kuliah, melewati fase denial → sadar → bangkit.",
  category: "motivation",
  initialSeverity: 3,
  turns: [
    {
...
export const multiKesepianKotaBaru: MultiTurnScenario = {
  ...
  name: "Kesepian — Adaptasi di Kota Baru",
  description:
...
export const multiInsecureAkademik: MultiTurnScenario = {
  ...
  name: "Insecure Akademik — Impostor Syndrome",
  description:
    "User merasa tidak pantas dengan pencapaian akademiknya. Dari insecure → menerima diri.",
  category: "insecure",
  initialSeverity: 4,
  turns: [
    {
...
export const multiBurnoutOrganisasi: MultiTurnScenario = {
  ...
  name: "Burnout — Kelelahan Organisasi Kampus",
  description:
    "User kelelahan karena terlalu banyak aktivitas organisasi. Dari burnout → mulai mengatur ulang prioritas.",
  category: "burnout",
  initialSeverity: 5,
  turns: [
    {
...
export const multiStressKuliah: MultiTurnScenario = {
  ...
  name: "Stress Kuliah — Deadline Bertumpuk",
  description:
    "User menghadapi deadline kuliah yang bertumpuk. Dari panik → terorganisir.",
  category: "stress",
  initialSeverity: 4,
  turns: [
    {
...
export const multiCemasMasaDepan: MultiTurnScenario = {
  ...
  name: "Kecemasan Masa Depan — Mau Lulus",
  description:
    "User cemas menghadapi masa depan setelah lulus kuliah. Dari cemas → mendapatkan perspektif.",
  category: "anxiety",
  initialSeverity: 3,
  turns: [
    {
