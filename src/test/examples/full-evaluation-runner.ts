...
async function main(): Promise<void> {
  ...
  console.log(
    `   → Menunjukkan peningkatan RAG: ${ragComparison.averageNonRagScore} → ${ragComparison.averageRagScore}`,
  );
  console.log(
    `   → RAG menang: ${ragComparison.ragWins}/${ragComparison.totalScenarios} skenario`,
  );
  console.log();
  ...
  console.log(
    `   → ${Object.keys(visualizationData).length} tipe data visualisasi`,
  );
