...
│
├── reports/
│   ├── sample-report.md               # Contoh laporan evaluasi (markdown)
│   └── report-generator.ts            # Generator laporan markdown otomatis
│
└── examples/
...
Lihat file `src/test/reports/sample-report.md` untuk contoh laporan evaluasi lengkap.
