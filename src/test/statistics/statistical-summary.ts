/**
 * ============================================================
 * STATISTICAL SUMMARY — RANGKUMAN STATISTIK EVALUASI
 * ============================================================
 *
 * Modul ini menghasilkan rangkuman statistik dari hasil evaluasi.
 *
 * Fitur:
 * - Rata-rata skor
 ...
 *
 * Output:
 * - Markdown (untuk dokumentasi skripsi)
 * - JSON (untuk olah data lanjutan)
 ...
 * Contoh: "overthinking_001" → "overthinking"
 */
