/**
 * RELEVANCE EVALUATOR — EVALUASI RELEVANSI RESPONS
 *
 * Evaluator ini mengukur relevansi respons chatbot terhadap:
 * 1. Konten — apakah respons menjawab/merespon konteks user
 * 2. Emosi — apakah respons sesuai dengan keadaan emosional user
 * 3. Tone — apakah nada bicara sesuai dengan situasi
 *
