/**
 * EMPATHY EVALUATOR — EVALUASI TINGKAT EMPATI CHATBOT
 *
 * Evaluator ini mengukur seberapa empatik respons chatbot
 * terhadap kondisi emosional user.
 *
 * Tiga dimensi empati yang diukur:
 * 1. EMOTIONAL VALIDATION — Apakah chatbot memvalidasi perasaan user?
 * 2. UNDERSTANDING — Apakah chatbot menunjukkan pemahaman?
 * 3. SUPPORTIVENESS — Apakah chatbot memberikan dukungan?
 *
