/**
 * CONTEXTUAL CONSISTENCY — KONSISTENSI KONTEKS RESPONS
 *
 * Evaluator ini mengukur seberapa konsisten respons chatbot
 * dengan konteks yang diberikan:
 *
 * 1. CHUNK CONSISTENCY — Apakah respons menggunakan informasi
 *    dari retrieved chunks?
 *
 * 2. EMOTIONAL CONSISTENCY — Apakah respons konsisten dengan
 *    arah emosional yang diharapkan?
 *
 * 3. NO CONTRADICTION — Apakah respons mengandung kontradiksi?
 *
 ...
 *   dengan benar — chatbot menggunakan konteks yang relevan
