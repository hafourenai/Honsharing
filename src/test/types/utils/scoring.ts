/**
 * ============================================================
 * SCORING UTILITY — ALAT BANTU SKORING EVALUASI
 * ============================================================
 *
 * Modul ini menyediakan fungsi-fungsi untuk:
 * 1. Normalisasi skor
 * 2. Konversi skor ke kategori
 * 3. Menghitung rata-rata tertimbang
 ...
 */
export type Verdict = "SANGAT_BAIK" | "BAIK" | "CUKUP" | "KURANG" | "TIDAK_MEMADAI"
...
export function getVerdictDescription(verdict: Verdict): string {
  const descriptions: Record<Verdict, string> = {
    ...
    BAIK:
      "Sistem menunjukkan performa yang baik. Sebagian besar respons sesuai dengan konteks emosional yang diharapkan.",
    CUKUP:
