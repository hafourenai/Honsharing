...
export const relationshipTrustScenario: TestScenario = {
  ...
  expectedRetrievedContext: [
    {
      chunkId: "emotion_0009",
      topic: "relationship",
      situation:
        "User mengalami pengkhianatan dalam hubungan, merasakan sakitnya putus cinta",
      expectedRelevanceScore: 0.95,
      emotions: ["grief", "heartbreak", "loss", "confusion"],
      needs: ["validation", "space to grieve", "companionship"],
    },
  ],
  ...
  expectedRetrievedContext: [
    {
      ...
      topic: "friendship",
      situation:
        "User mengalami konflik komunikasi dengan orang terdekat, merasa tidak dipahami",
