/**
 * RETRIEVAL ACCURACY â€” EVALUASI AKURASI RETRIEVAL RAG
 *
 * Evaluator ini mengukur seberapa akurat sistem RAG dalam
 * meretrieve chunk yang relevan dengan query user.
 *
 * Metrik yang digunakan:
 * 1. PRECISION â€” Dari semua chunk yang diretrieve, berapa
 *    banyak yang benar-benar relevan?
 *    Rumus: TP / (TP + FP)
 *
 * 2. RECALL â€” Dari semua chunk yang seharusnya diretrieve,
 *    berapa banyak yang berhasil diambil?
 *    Rumus: TP / (TP + FN)
 *
 * 3. AVG RELEVANCE SCORE â€” Rata-rata skor similarity dari
